...
contract StarNotary is ERC721 {
    ...
    function lookUptokenIdToStarInfo (uint256 _tokenId) public view returns (string memory name) {
        require(bytes(tokenIdToStarInfo[_tokenId].name).length > 0, "Token has not been minted");
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(owner1 == _msgSender() || owner2 == _msgSender(), "Onwer of token1 OR owner of token2 are NOT the message sender");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(owner == _msgSender(), "The owner of the transfered of this star is not the sender of the message to blockchain");
